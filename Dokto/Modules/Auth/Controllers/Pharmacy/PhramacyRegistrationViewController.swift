//
//  PhramacyRegistrationViewController.swift
//  Dokto
//
...
class PhramacyRegistrationViewController: AbstractViewController {
    @IBOutlet weak var pharmacyImageView: UIImageView!
    @IBOutlet weak var pharmacyNameField: UITextField!
    @IBOutlet weak var mobileNumberCountryCodeField: UITextField!
    @IBOutlet weak var mobilenumberField: UITextField!
    @IBOutlet weak var mobileNumberdropDownButton: UIButton!
    @IBOutlet weak var pharmacyEmailField: UITextField!
    ...
    var clinicImage: UIImage? {
        didSet {
            pharmacyImageView.image = clinicImage
        }
    }
...
//MARK - Action methods
extension PhramacyRegistrationViewController {
    ...
    @IBAction func submitAction(_ sender: Any) {
        ...
        let fullName = pharmacyNameField.text
        let email = pharmacyEmailField.text
        let password = passWordField.text
        let numberOfpractitioners = NumberofPractitionersField.text
        let image = pharmacyImageView.image?.toBase64() ?? "String"
...
extension PhramacyRegistrationViewController{
    ...
    func validateregistrationData()-> Bool{
        ...
        if pharmacyNameField.text?.trimmingCharacters(in: .newlines) == "" {
        ...
        else if let clinicEmail = pharmacyEmailField.text?.trimmingCharacters(in: .whitespacesAndNewlines), !clinicEmail.isValidEmail() {
        ...
        else if pharmacyImageView.image == nil {
